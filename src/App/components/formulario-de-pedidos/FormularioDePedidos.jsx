            ...
            <Form className={Styles.body} onSubmit={handleSubmit(onSubmit)}>
                <Row mb={6}>
                    <Form.Group md={4} as={Col}>
                        ...
                        <Col className={Styles.spam}><span className={Styles.spam}>{errors?.cliente && errors.cliente.message}</span></Col>
                    </Form.Group>
                    <Form.Group md={3} as={Col}>
                        ...
                        <Col className={Styles.spam}><span className={Styles.spam}> {errors?.celular && errors.celular.message} </span></Col>
                    </Form.Group>
                    <Form.Group md={3} as={Col}>
                        ...
                        <Col className={Styles.spam}><span className={Styles.spam}> {errors?.fechaEntrega && errors.fechaEntrega.message} </span></Col>
                    </Form.Group>
                    <Form.Group md={2} as={Col}>
                        ...
                        <Col className={Styles.spam}><span className={Styles.spam}>{errors?.importe && errors.importe.message}</span></Col>
                    </Form.Group>
                </Row>
                <Row mb={6}>
                    <Form.Group as={Col}>
                        ...
                        <Col className={Styles.spam}><span className={Styles.spam}>{errors?.pedido && errors.pedido.message}</span></Col>
                    </Form.Group>
                </Row>
